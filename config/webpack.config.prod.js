...
const shouldUseSourceMap = process.env.GENERATE_SOURCEMAP !== 'false'; //eslint-disable-line no-process-env
...
module.exports = {
  ...
  resolve: {
    ...
    modules: [ 'node_modules', paths.appNodeModules ].concat(
      ...
      process.env.NODE_PATH.split(path.delimiter).filter(Boolean) //eslint-disable-line no-process-env
    ),
